...
if($return_value == 1){
    echo '<span style="color:#F00;text-align:center;">ERROR: The number of projects input doesnt equal to the number of projects in Sample Sheet! Please double check!<br><br></span>';
#    shell_exec("sudo rm /var/www/html/upload/tmp/*");
    exit();
}
else
if($return_value == 2){
    echo '<span style="color:#F00;text-align:center;">ERROR: Sample names should not include any sign like "+" in sample sheet, please correct it.</span>';
#    shell_exec("sudo rm /var/www/html/upload/tmp/*");
    exit(); 
}
else
if($return_value == 3){
    echo '<span style="color:#F00;text-align:center;">ERROR1: Sample names should not include any sign like "+" in sample sheet, please correct it.<br></span>';
...
if ($returnvalue != 0){
	...
	echo "<br/><br/>";
         ...
         $subject="MiSeq $sequencing_id Submission Summary";
